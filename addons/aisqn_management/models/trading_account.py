...
class TradingAccount(models.Model):
    _name = 'uni.invest.trading.account'
    ...
    update_last_by_id = fields.Many2one('uni.invest.user', string='Updated Last By')
    ...
    broker_id = fields.Many2one('uni.invest.broker', string='Broker')
