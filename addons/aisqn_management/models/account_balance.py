...
class AccountBalance(models.Model):
    ...
    last_updated_date_time = fields.Datetime(string='Last Updated Date Time')
    last_updated_user = fields.Many2one('uni.user', string='Last Updated By')
